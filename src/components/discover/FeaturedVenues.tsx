...
export async function FeaturedVenues({ venues }: { venues: Venue[] }) {
  ...
  return (
    <section className="rounded-[2rem] border border-gray-200 bg-white p-6 shadow-lg shadow-gray-100 sm:p-8">
      <SectionHeader
        ...
        title={t(locale, "featured.featuredEstablishments")}
        description={t(locale, "featured.featuredEstablishmentsDesc")}
        viewAllHref="/discover/venues"
