    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm leading-relaxed">
              GoSwing is a community-driven platform. From parties, dinners, drinks, and more.
              Join us to discover and create amazing events.
            </p>
          ...
          {/* For Organizers */}
          <div>
            <h4 className="font-semibold text-white">For Organizers</h4>
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <a href="#" className="transition-colors hover:text-white">
                  Create Events
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-gray-800 pt-8 md:flex-row">
          <p className="text-sm">© 2024 GoSwing. All rights reserved.</p>
